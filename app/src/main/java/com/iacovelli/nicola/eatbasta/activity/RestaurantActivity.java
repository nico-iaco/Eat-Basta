...
public class RestaurantActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Restaurant> restaurantArrayList = new ArrayList<>(Arrays.asList(
                new Restaurant("Panucci's pizza", "The best pizza ever", R.drawable.logo, 10),
                new Restaurant("Calabrese", "Mannaia a tia", R.drawable.logo, 15),
                new Restaurant("Burger king", "Tutti i miei amici vanno a burger king", R.drawable.logo, 20),
                new Restaurant("Mensa elis", "Ogni giorno surprise", R.drawable.logo, 50)
        ));
